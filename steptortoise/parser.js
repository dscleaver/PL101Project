  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_statement() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, v) { return { tag: 'var', name: v, initial: 0 }; })(pos0, result0[2]);
            }
            if (result0 === null) {
              pos = pos0;
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, v, expr) { return { tag: 'var', name: v, initial: expr }; })(pos0, result0[2], result0[6]);
              }
              if (result0 === null) {
                pos = pos0;
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, op, expr, body) { return { tag: op, expr: expr, body: body }; })(pos0, result0[0], result0[4], result0[10]);
                }
                if (result0 === null) {
                  pos = pos0;
                }
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, neg, chars, frac) { return parseFloat(neg + chars.join('') + frac); })(pos0, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
